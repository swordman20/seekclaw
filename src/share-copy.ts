...
const REMOTE_SHARE_COPY_URL = "https://seekclaw.cn/config/share-copy-content.json";
...
const FALLBACK_SHARE_COPY_PAYLOAD: ShareCopyPayload = {
  ...
  locales: {
    zh: {
      title: "分享 SeekClaw 给朋友",
      subtitle: "复制下面这段文案分享给你的朋友或群聊，作者会非常感谢你哟😘",
      body: [
        "我最近在用 SeekClaw，很快就安装好了 OpenClaw。",
        "",
        "SeekClaw 是 OpenClaw 的一键安装包，几分钟就能装好并开始用。",
        "",
        "他们说 OpenClaw 可以做这些事：",
        ...
        "",
        "想低成本把内容、运营、办公、招聘自动化，可以直接试试：seekclaw.cn",
      ].join("\n"),
    },
    en: {
      title: "Share SeekClaw with friends",
      subtitle:
        "Copy this text and share it with your friends or group chats. The creator will really appreciate it 😘",
      body: [
        "I've been using SeekClaw lately, and it seriously boosts execution speed.",
        "",
        "SeekClaw is a one-click installer for OpenClaw, so you can get started in minutes.",
        "",
        ...
        "",
        "If you want low-cost automation for content, operations, office, and recruiting, try: seekclaw.cn",
      ].join("\n"),
    },
  },
};
