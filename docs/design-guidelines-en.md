# SeekClaw Design Guidelines

The SeekClaw main interface (Chat UI) exhibits a **minimalist, modern, lightweight, and breathable** design language. Below are the core dimensions of the design guidelines:
...
SeekClaw's signature red theme color is: **`#c0392b`**
