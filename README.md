<p align="center">
  <img src="assets/icon.png" width="120" alt="SeekClaw Logo" />
</p>
...
SeekClaw 把 [OpenClaw](https://github.com/anthropics/claude-code) 打包成一个**开箱即用**的桌面应用。内置 Node.js 运行时和完整的 OpenClaw Gateway，你不需要任何开发工具链。
...
| 平台 | 架构 | 下载 |
|---|---|---|
| 🍎 macOS | Apple Silicon (M1/M2/M3/M4) | `SeekClaw-x.x.x-arm64.dmg` |
| 🍎 macOS | Intel | `SeekClaw-x.x.x-x64.dmg` |
| 🪟 Windows | x64 | `SeekClaw-Setup-x.x.x-x64.exe` |
| 🪟 Windows | ARM64 | `SeekClaw-Setup-x.x.x-arm64.exe` |
...
**Q: 飞书频道是什么？**
A: 你可以把 SeekClaw 连接到飞书，让它作为飞书工作区中的聊天机器人工作。
...
[![Star History Chart](https://api.star-history.com/svg?repos=seekclaw/seekclaw&type=Date)](https://star-history.com/#swordman20/seekclaw&Date)
...
SeekClaw wraps [OpenClaw](https://github.com/anthropics/claude-code) into a **ready-to-use** desktop app. It bundles a Node.js runtime and the full OpenClaw Gateway — zero dev tooling required.
...
| 💬 **Chat Integrations** | Built-in Feishu and QQ bot access for chatting with SeekClaw from messaging apps |
...
You define the goal, SeekClaw executes.
...
A: Absolutely! SeekClaw is designed for non-technical users 😊
...
A: You can connect SeekClaw to Feishu (Lark) so it works as a chat bot in your Feishu workspace.

---

### ⭐ Like it? Give us a Star!

If SeekClaw saves you time, drop a ⭐ Star — it means a lot and keeps us going! 💪❤️
